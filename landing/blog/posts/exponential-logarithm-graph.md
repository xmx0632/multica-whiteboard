---
title: 指数与对数函数图像：一块白板讲透"互为反函数"
description: 在线白板同屏画 y=2^x 与 y=log(x,2)，两曲线关于 y=x 对称、特殊点对调、定义域值域互换，反函数关系一眼看懂。附操作步骤与截图。
date: 2026-09-09
category: 函数图像教学
tags: [教学白板, 指数函数, 对数函数, 函数图像绘制]
cover: assets/blog/exponential-logarithm-graph/board-explog.png
ogimage: assets/blog/exponential-logarithm-graph/og.png
summary: 对数图像是高频失分点：学生总把它画成过 (0,1)，或者与指数曲线傻傻分不清。"互为反函数、关于 y=x 对称"这句话，黑板上是靠老师口述的。本文演示在教学白板上同屏画两条曲线，让这层关系自己显形。
---
